...
class MetatagsService
{
    ...
    public function features(): array
    {
        ...
        foreach ($features as $feature) {
            ...
            $this->$method($hasMultisite);
        }

        return $this->fields->flatten(1)->all();
    }

    public function forFeatures(array $features): array
    {
        $hasMultisite = Site::hasMultiple();
    ...
    protected function basic(bool $localizable): self
    {
        $this->fields->add([
            [
    ...
    protected function advanced(bool $localizable): self
    {
        $this->fields->add([
            [
    ...
    protected function siteVerifications(bool $localizable): self
    {
        $this->fields->add([
            [
    ...
    protected function dublinCore(bool $localizable): self
    {
        $this->fields->add([
            [
    ...
    protected function dublinCoreAdvanced(bool $localizable): self
    {
        $this->fields->add([
            [
    ...
    protected function googlePlus(bool $localizable): self
    {
        $this->fields->add([
            [
    ...
    protected function og(bool $localizable): self
    {
        $this->fields->add([
            [
    ...
    protected function facebook(bool $localizable): self
    {
        $this->fields->add([
            [
    ...
    protected function twitter(bool $localizable): self
    {
        $this->fields->add([
            [
    ...
    protected function pinterest(bool $localizable): self
    {
        $this->fields->add([
            [
    ...
    protected function appLinks(bool $localizable): self
    {
        $this->fields->add([
            [
    ...
    protected function mobile(bool $localizable): self
    {
        $this->fields->add([
            [
    ...
    protected function apple(bool $localizable): self
    {
        $this->fields->add([
            [
    ...
    protected function android(bool $localizable): self
    {
        $this->fields->add([
            [
    ...
    protected function favicons(bool $localizable): self
    {
        $this->fields->add([
            [
