...
Route::prefix('metatags')->group(function () {
    ...
    Route::patch('/settings', [SettingsController::class, 'update'])->name('metatags.settings.update');

    Route::get('/defaults', [DefaultsController::class, 'edit'])->name('metatags.defaults');
    Route::patch('/defaults', [DefaultsController::class, 'update'])->name('metatags.defaults.update');
    ...
    Route::prefix('blueprints')->group(function () {
        ...
        Route::prefix('/{type}/{entity}/{name}')->group(function () {
            ...
            Route::patch('/settings', [BlueprintsController::class, 'updateSettings'])->name('metatags.blueprints.updateSettings');
            Route::get('/defaults', [BlueprintsController::class, 'editDefaults'])->name('metatags.blueprints.editDefaults');
            Route::patch('/defaults', [BlueprintsController::class, 'updateDefaults'])->name('metatags.blueprints.updateDefaults');
        });
    });
});
